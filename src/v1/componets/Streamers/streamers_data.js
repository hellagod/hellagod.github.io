...
const streamers = {
    ...
    "ybicanoooobov": {
        ...
        about: (
            <>
                Ветеран комментаторской сцены Dota 2, всегда с глубоким аналитическим подходом и узнаваемым стилем подачи<br/>
            </>
        ),
        socials: [
    ...
    "ct0m": {
        ...
        about: (
            <>
                Спокойный и вдумчивый контент-мейкер, делает акцент на качестве и полезности своих трансляций<br/>
            </>
        ),
        socials: [
    ...
    "leva2k": {
        ...
        about: (
            <>
                IRL стример, его путешествия заставят вас погрузиться в атмосферу другой стороны курортов. <br/>
            </>
        ),
        socials: [
